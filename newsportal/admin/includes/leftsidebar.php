...
<!--laters news-->
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Hot News  </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="latestn.php">Add Hot News</a></li>
                                    <li><a href="manage_hotn.php">Manage  Hot News</a></li>
                                </ul>
                            </li>                             
                     <!--/-->
